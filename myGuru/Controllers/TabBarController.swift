...
//
//        init(itemListViewModel: ItemListViewModel, tabBarItems: [TabBarItem], controllers: [TabBarItem: UIViewController]) {
...
//        }
//    
//    private func setupTabBar(tabBarItems: [TabBarItem], controllers: [TabBarItem: UIViewController]) {
